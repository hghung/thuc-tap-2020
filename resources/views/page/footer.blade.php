<footer class="page_footer ds parallax section_padding_top_90 section_padding_bottom_100 columns_padding_25">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-7 col-sm-2 col-md-pull-1 ">
				<div class="widget topmargin_25">
					<a href="{{ route('home1') }}"  class="logo top_logo bottommargin_40">
					...
					<div class="topmargin_30">
						<div class="media small-teaser inline-block">
							...
							<div class="media-body media-middle" style="color: #f3bb21">
								29 Đường Cách Mạng Tháng 8, Thới Bình, Ninh Kiều, Cần Thơ
							</div>
						</div>
						<br>
						<div class="media small-teaser inline-block">
			...
			<div class="col-md-5 col-sm-6">
				<div class="widget widget_mailchimp topmargin_25">
					...
					<h3 class="widget-title">BẢN TIN</h3>

					<form class="signup" action="#" method="get">
						<p style="color: #f3bb21">Nhập địa chỉ email của bạn ở đây để luôn được cập nhật. Chúng tôi hứa không gửi thư rác !</p>
						<div class="form-group">
							<input name="email" type="email" class="mailchimp_email form-control text-center" placeholder="Email Address">
						</div>
						<div class="topmargin_30">
