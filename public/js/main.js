...
function windowLoadInit() {
	...
	jQuery('form.contact-form').on('submit', function( e ){
		...
		var ajax = jQuery.post( "http://webdesign-finder.com/html/fixit/js/contact-form.php", request )
		.done(function( data ) {
	...
	jQuery('form.searchform').on('submit', function( e ){
		...
		//sending form data to PHP server if fields are not empty
		var request = $form.serialize();
		var ajax = jQuery.post( "http://webdesign-finder.com/html/fixit/js/search.php", request )
		.done(function( data ) {
	...
	jQuery('.signup').on('submit', function( e ) {
		...
		jQuery.ajax({
			url: 'http://webdesign-finder.com/html/fixit/js/mailchimp/store-address.php',
	...
	//see 'plugins.js'/*tpa=http://webdesign-finder.com/html/fixit/js/plugins.js*/ file
	...
	if (jQuery().elevateZoom) {
		jQuery('#product-image').elevateZoom({
			...
			responsive:true, 
			loadingIcon: 'AjaxLoader.gif'/*tpa=http://webdesign-finder.com/html/fixit/js/img/AjaxLoader.gif*/
		});
	}
	...
	jQuery('.review-link').on('click', function( e ) {
		...
		if (!reviewTabLink.parent().hasClass('active')) {
			reviewTabLink
			.tab('show')
			.on('http://webdesign-finder.com/html/fixit/js/shown.bs.tab', function (e) {
	...
	if (jQuery().appear) {
		...
		if (jQuery().progressbar) {
			...
			jQuery('a[data-toggle="tab"]').on('http://webdesign-finder.com/html/fixit/js/shown.bs.tab', function(e) {
